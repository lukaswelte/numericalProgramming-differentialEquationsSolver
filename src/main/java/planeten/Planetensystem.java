...
public class Planetensystem {
	...
	public Planetensystem() {
		addPlanet("Sonne", 1.9891E30, 1392700, new Color(224, 215, 75), 0, 0, 0, 0);
		addPlanet("Merkur", 3.302E23, 4879.4, new Color(166, 115, 53), 57.909E6, 0, 0, -47.87);
		addPlanet("Venus", 4.869E24, 12103.6, new Color(120, 74, 32), 108.16E6, 0, 0, -35.02);
		addPlanet("Erde", 5.974E24, 12756.32, new Color(2, 60, 106), 149.6E6, 0, 0, -29.78);
		addPlanet("Mars", 6.419E23, 6792.4, new Color(155, 129, 104), 227.99E6, 0, 0, -24.13);
		addPlanet("Jupiter", 1.899E27, 142984, new Color(148, 144, 145), 778.36E6, 0, 0, -13.07);
		addPlanet("Saturn", 5.685E26, 120536, new Color(179, 160, 129), 1433.4E6, 0, 0, -9.69);
		addPlanet("Uranus", 8.683E25, 51118, new Color(192, 230, 233), 2872.4E6, 0, 0, -6.81);
		addPlanet("Neptun", 1.0243E26, 49528, new Color(102, 155, 241), 4495E6, 0, 0, -5.43);

		addPlanet("Mond", 7.349E22, 3476, new Color(1, 1, 0), 149.6E6, 384400, 1.023, -29.78);
		addPlanet("Hale-Bopp", 1.3E16, 60, new Color(0, 0, 0), -0.914*149.6E6, 0, 0, 44.005);
		addPlanet("HalleyscherKomet", 2E14, 10, new Color(0, 0, 0), -0.568*149.6E6, 0, 0, 54.57);
